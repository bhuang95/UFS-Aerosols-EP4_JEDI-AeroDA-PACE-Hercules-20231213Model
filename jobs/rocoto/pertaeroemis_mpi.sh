...
#HOMEgfs_HBO="/home/bohuang/Workflow/UFS-Aerosols_NRTcyc/UFS-Aerosols-EP4_JEDI-AeroDA-Reanl-Hercules-20231213Model/"
#source "${HOMEgfs_HBO}/ush/preamble.sh"
#source "$HOMEgfs_HBO/ush/load_ufswm_modules.sh"
ulimit -s unlimited
...
export LD_LIBRARY_PATH="/work/noaa/wrf-chem/bhuang/expCodes-Hercules/MariusLibs/libs/fortran-datetime/lib:${LD_LIBRARY_PATH}"
