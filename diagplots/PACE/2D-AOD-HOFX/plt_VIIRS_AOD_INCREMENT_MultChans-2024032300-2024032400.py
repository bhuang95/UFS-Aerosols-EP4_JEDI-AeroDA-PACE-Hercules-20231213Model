...
if __name__ == '__main__':
    ...
    for ichan in range(len(chans)):
        ...
        anl2bkg_in = anl2bkg[validind, ichan]
        titlepre_in = f"{titlepre}-Increment-{wav}"
        plot_map_satter_inc(lon_in, lat_in, obs_in, anl2bkg_in, cmap_aod, cmap_bias, titlepre_in, cycpre)
